...
class SubscriptionExtractor:
    ...
    def telecom_subscription_extraction(self):
        try:
            ...
            for item in self.sms_data:
                ...
                if channel in ['810', '251994', 'Yimulu']:
                
                    financial_keywords = ["recharge", "recharged", "transferred", "transfer", "provided", "covered"]
                    ...
                    if found:
                        try:
                            ...
                            response = model.generate_content(f"In this given telecommunication SMS text, {body}, please extract important information only transaction type (i.e. credit or recharge), amount, balance, in json format of key:value")
                            response.resolve()
...
if __name__ == "__main__":
    ...
    extract_sms = SubscriptionExtractor(sms_data)
    extracted_package_info = extract_sms.telecom_subscription_extraction()
